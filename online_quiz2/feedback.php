...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">admin@admin.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="http://yugeshverma.blogspot.in" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook"> Group HHR</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 8951992123</h4>
		<h4 style="font-family:'typo' ">renuka@gmail.com</h4>
